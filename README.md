...
This is the code for the "How to Do Linear Regression the Right Way - Como fazer a regressão linear do jeito certo" live session by Siraj Raval on Youtube
